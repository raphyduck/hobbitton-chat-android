...
enum class EModelEndpoint {
    @SerialName("azureOpenAI") AZURE_OPENAI,
    @SerialName("openAI") OPENAI,
    @SerialName("google") GOOGLE,
    @SerialName("anthropic") ANTHROPIC,
    @SerialName("assistants") ASSISTANTS,
    @SerialName("azureAssistants") AZURE_ASSISTANTS,
    @SerialName("agents") AGENTS,
...
enum class ContentType {
    ...
    @SerialName("image_file") IMAGE_FILE,
    @SerialName("image_url") IMAGE_URL,
    @SerialName("video_url") VIDEO_URL,
    @SerialName("input_audio") INPUT_AUDIO,
    @SerialName("agent_update") AGENT_UPDATE,
...
enum class StepType {
    ...
    @SerialName("message_creation") MESSAGE_CREATION,
}
...
enum class ToolCallType {
    ...
    @SerialName("file_search") FILE_SEARCH,
    @SerialName("code_interpreter") CODE_INTERPRETER,
    @SerialName("tool_call") TOOL_CALL,
}

@Serializable
enum class FeedbackRating {
    @SerialName("thumbsUp") THUMBS_UP,
    @SerialName("thumbsDown") THUMBS_DOWN,
}
...
enum class Provider {
    @SerialName("openAI") OPENAI,
    @SerialName("anthropic") ANTHROPIC,
    @SerialName("azureOpenAI") AZURE,
    @SerialName("google") GOOGLE,
    @SerialName("vertexai") VERTEXAI,
    @SerialName("bedrock") BEDROCK,
    @SerialName("mistralai") MISTRALAI,
