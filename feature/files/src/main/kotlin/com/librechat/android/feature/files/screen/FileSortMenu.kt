...
import com.librechat.android.feature.files.viewmodel.FileSortField
import com.librechat.android.feature.files.viewmodel.FileSortOrder
            ...
            DropdownMenuItem(
                ...
                onClick = {
                    if (isSelected) {
                        ...
                        // Select field with default descending
                ...
                trailingIcon = if (isSelected) {
                    {
                        Icon(
                            ...
                            contentDescription = if (currentSortOrder == FileSortOrder.ASCENDING) {
                                stringResource(R.string.cd_ascending)
                            } else {
                                stringResource(R.string.cd_descending)
                            },
                        )
                    }
                } else {
