    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            FormatRow(
                ...
                label = stringResource(R.string.format_json),
                description = stringResource(R.string.format_json_description),
                onClick = {
                    onDismiss()
            ...
            FormatRow(
                ...
                label = stringResource(R.string.format_markdown),
                description = stringResource(R.string.format_markdown_description),
                onClick = {
                    onDismiss()
