        ...
        Row(
            ...
            IconButton(onClick = { expanded = !expanded }) {
                Icon(
                    ...
                    contentDescription = if (expanded) stringResource(R.string.cd_hide_tags) else stringResource(R.string.cd_show_tags),
            ...
            if (selectedTags.isNotEmpty() && !expanded) {
                Text(
                    text = stringResource(R.string.tags_active_count, selectedTags.size, if (selectedTags.size > 1) "s" else ""),
