...
fun ArchivedConversationsScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.archived_conversations)) },
                navigationIcon = {
        ...
        PullToRefreshBox(
            ...
            when {
                ...
                !uiState.isLoading && uiState.conversations.isEmpty() && uiState.error != null -> {
                    ErrorBanner(
                        message = uiState.error ?: stringResource(R.string.could_not_load_archived),
                        onRetry = {
                ...
                !uiState.isLoading && uiState.conversations.isEmpty() -> {
                    EmptyState(
                        title = stringResource(R.string.no_archived_conversations),
                        description = stringResource(R.string.archived_will_appear_here),
