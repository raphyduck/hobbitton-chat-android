...
/** One audio file as picked: its bytes and what they claim to be. */
class PickedAudio(val bytes: ByteArray, val mime: String)
 ...
 * audio, so « send an audio » honestly means « transcribe it and send the words » — the caller does
