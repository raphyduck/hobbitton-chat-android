...
fun AgentHandoffConfig(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Row(
            ...
            Text(
                text = stringResource(R.string.handoff_agents_count, handoffAgentIds.size),
        ...
        AnimatedVisibility(visible = expanded) {
            Column(
                ...
                if (handoffAgentIds.isEmpty()) {
                    Text(
                        text = stringResource(R.string.no_handoff_agents),
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                        ...
                        trailingIcon = {
                            IconButton(onClick = { onRemoveHandoff(agentId) }) {
                                Icon(
                                    ...
                                    contentDescription = stringResource(R.string.cd_remove_item, displayName),
                                )
                            }
                        },
                    )
                ...
                OutlinedButton(
                    ...
                    Text(stringResource(R.string.add_handoff_agent))
                }
            }
        }
    }
...
private fun AddHandoffAgentDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(R.string.add_handoff_agent)) },
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                if (availableAgents.isEmpty()) {
                    Text(
                        text = stringResource(R.string.no_more_agents),
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {},
                            readOnly = true,
                            label = { Text(stringResource(R.string.select_agent)) },
                            trailingIcon = {
