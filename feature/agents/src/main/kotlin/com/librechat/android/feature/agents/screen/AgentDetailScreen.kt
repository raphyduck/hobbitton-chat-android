...
fun AgentDetailScreen(
    ...
    if (uiState.showDeleteDialog) {
        AlertDialog(
            ...
            text = {
                Text(stringResource(R.string.delete_agent_confirm, uiState.agent?.name ?: stringResource(R.string.delete_this_agent)))
            },
            confirmButton = {
                TextButton(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(uiState.agent?.name ?: stringResource(R.string.agent_title)) },
                navigationIcon = {
            ...
            uiState.agent != null -> {
                ...
                Column(
                    ...
                    if (!tools.isNullOrEmpty()) {
                        Spacer(modifier = Modifier.height(16.dp))
                        Text(
                            text = stringResource(R.string.label_tools),
