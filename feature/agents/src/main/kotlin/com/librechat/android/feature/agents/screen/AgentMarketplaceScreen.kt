...
fun AgentMarketplaceScreen(
    ...
    Scaffold(
        modifier = modifier,
        topBar = {
            LibreChatTopBar(title = stringResource(R.string.agents))
        },
        floatingActionButton = {
            FloatingActionButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.cd_create_agent),
                )
            }
        },
    ) { innerPadding ->
        PullToRefreshBox(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text(stringResource(R.string.search_agents_hint)) },
                    leadingIcon = {
                        Icon(
                    ...
                    !uiState.isLoading && uiState.filteredAgents.isEmpty() && uiState.error == null -> {
                        EmptyState(
                            title = if (uiState.searchQuery.isNotBlank() || uiState.selectedCategory != null) {
                                stringResource(R.string.no_agents_found)
                            } else {
                                stringResource(R.string.no_agents_available)
                            },
        ...
        Column(
            ...
            Row(
                ...
                AvatarImage(
                    ...
                    fallbackIconRes = CoreUiR.drawable.ic_agents,
                    tintIcon = true,
                )
            }
            Spacer(modifier = Modifier.height(8.dp))
            ...
            Spacer(modifier = Modifier.height(4.dp))
            Text(
                text = agent.authorName ?: agent.author ?: stringResource(R.string.unknown_author),
