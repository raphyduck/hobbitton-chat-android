...
fun AgentActionsPanel(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Row(
            ...
            Text(
                text = stringResource(R.string.openapi_actions_count, actions.size),
        ...
        AnimatedVisibility(visible = expanded) {
            Column(
                ...
                if (actions.isEmpty()) {
                    Text(
                        text = stringResource(R.string.no_actions_configured),
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = action.domain ?: stringResource(R.string.unknown_author),
                ...
                Text(
                    text = stringResource(R.string.action_auth_info, authLabel, action.functionCount),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
            }
            Row {
                IconButton(onClick = onEdit) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.cd_edit_action),
                    )
                }
    ...
    Dialog(
        ...
        Scaffold(
            topBar = {
                Surface(tonalElevation = 2.dp) {
                    Row(
                        ...
                        Text(
                            text = if (isEditing) stringResource(R.string.edit_action) else stringResource(R.string.add_action),
            ...
            Column(
                ...
                // 2. Schema input
                Text(
                    text = stringResource(R.string.label_openapi_schema),
                    style = MaterialTheme.typography.titleSmall,
                )
                Text(
                    text = stringResource(R.string.openapi_schema_hint),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
                OutlinedTextField(
                ...
                if (parsedDomain.isNotBlank()) {
                    Text(
                        text = stringResource(R.string.domain_prefix, parsedDomain),
                ...
                if (parsedFunctionInfos.isNotEmpty()) {
                    HorizontalDivider()
                    Text(
                        text = stringResource(R.string.available_actions_count, parsedFunctionInfos.size),
                        style = MaterialTheme.typography.titleSmall,
                    )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.label_privacy_policy_url)) },
...
private fun AuthenticationSection(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Text(
            text = stringResource(R.string.label_authentication),
            style = MaterialTheme.typography.titleSmall,
        )
        ...
        OutlinedButton(
            ...
            Text(
                text = when (authType) {
                    "service_http" -> stringResource(R.string.auth_api_key_full)
                    "oauth" -> stringResource(R.string.auth_oauth_full)
                    else -> stringResource(R.string.auth_no_auth)
                },
            )
        }
    }
...
private fun AuthConfigDialog(
    ...
    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text(stringResource(R.string.label_authentication)) },
        text = {
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Text(
                    text = stringResource(R.string.label_authentication_type),
                    style = MaterialTheme.typography.labelLarge,
                )

                AuthTypeRadioOption(
                    label = stringResource(R.string.auth_none),
                ...
                AuthTypeRadioOption(
                    label = stringResource(R.string.auth_oauth),
                ...
                AnimatedVisibility(visible = selectedAuthType == "service_http") {
                    Column(
                        ...
                        HorizontalDivider()
                        Text(
                            text = stringResource(R.string.label_api_key_settings),
                            style = MaterialTheme.typography.labelLarge,
                        )
                        ...
                        Text(
                            text = stringResource(R.string.label_authorization_type),
                            style = MaterialTheme.typography.labelMedium,
                        )

                        AuthTypeRadioOption(
                            label = stringResource(R.string.auth_basic),
                            selected = localAuthorizationType == "basic",
                            onClick = { localAuthorizationType = "basic" },
                        )
                        AuthTypeRadioOption(
                            label = stringResource(R.string.auth_bearer),
                            selected = localAuthorizationType == "bearer",
                            onClick = { localAuthorizationType = "bearer" },
                        )
                        AuthTypeRadioOption(
                            label = stringResource(R.string.auth_custom),
                        ...
                        AnimatedVisibility(visible = localAuthorizationType == "custom") {
                            OutlinedTextField(
                                ...
                                label = { Text(stringResource(R.string.label_custom_auth_header)) },
                ...
                AnimatedVisibility(visible = selectedAuthType == "oauth") {
                    Column(
                        ...
                        HorizontalDivider()
                        Text(
                            text = stringResource(R.string.label_oauth_settings),
                            style = MaterialTheme.typography.labelLarge,
                        )
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.label_authorization_url)) },
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.label_token_url)) },
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.label_scope)) },
                        ...
                        Text(
                            text = stringResource(R.string.label_token_exchange_method),
                            style = MaterialTheme.typography.labelMedium,
                        )

                        AuthTypeRadioOption(
                            label = stringResource(R.string.token_default_post),
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.table_method),
                    style = MaterialTheme.typography.labelMedium,
                    fontWeight = FontWeight.Bold,
                    modifier = Modifier.width(60.dp),
                )
                Text(
                    text = stringResource(R.string.table_path),
                    style = MaterialTheme.typography.labelMedium,
                    fontWeight = FontWeight.Bold,
