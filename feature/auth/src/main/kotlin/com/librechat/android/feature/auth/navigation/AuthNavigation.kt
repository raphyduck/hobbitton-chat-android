package com.librechat.android.feature.auth.navigation
...
import com.librechat.android.feature.auth.screen.ForgotPasswordScreen
import com.librechat.android.feature.auth.screen.LoginScreen
import com.librechat.android.feature.auth.screen.RegisterScreen
import com.librechat.android.feature.auth.screen.ResetPasswordScreen
import com.librechat.android.feature.auth.screen.ServerUrlScreen
import com.librechat.android.feature.auth.screen.TermsScreen
import com.librechat.android.feature.auth.screen.TwoFactorScreen
import com.librechat.android.feature.auth.screen.VerifyEmailScreen
...
fun NavController.navigateToVerifyEmail(email: String) {
    navigate("verify_email/${Uri.encode(email)}")
}

fun NavController.navigateToResetPassword(userId: String, token: String) {
    navigate("reset_password/${Uri.encode(userId)}/${Uri.encode(token)}")
}
