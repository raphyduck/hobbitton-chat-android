...
fun FullscreenImageViewer(
                ...
                try {
                    ...
                    if (bitmap == null) {
                        withContext(Dispatchers.Main) {
                            Toast.makeText(context, context.getString(R.string.toast_failed_to_load_image), Toast.LENGTH_SHORT)
                                .show()
                        }
                        return@launch
                    }
                        ...
                        withContext(Dispatchers.IO) {
                            ...
                            if (uri == null) {
                                withContext(Dispatchers.Main) {
                                    Toast.makeText(
                                        context,
                                        context.getString(R.string.toast_failed_to_save_image),
                                        Toast.LENGTH_SHORT,
                                    ).show()
                                }
                                return@withContext
                    ...
                    withContext(Dispatchers.Main) {
                        Toast.makeText(context, context.getString(R.string.toast_image_saved), Toast.LENGTH_SHORT)
                            .show()
                    }
                } catch (e: Exception) {
                    withContext(Dispatchers.Main) {
                        Toast.makeText(
                            context,
                            context.getString(R.string.toast_failed_to_save_with_error, e.localizedMessage ?: ""),
                            Toast.LENGTH_SHORT,
                        ).show()
                    }
                }
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted && pendingSaveAfterPermission) {
            ...
            pendingSaveAfterPermission = false
            Toast.makeText(context, context.getString(R.string.toast_storage_permission_required), Toast.LENGTH_SHORT)
                .show()
        }
    }
            ...
            Row(
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.cd_save_to_device),
                    )
                }
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.cd_share_image),
                    )
                }
            }
        }
