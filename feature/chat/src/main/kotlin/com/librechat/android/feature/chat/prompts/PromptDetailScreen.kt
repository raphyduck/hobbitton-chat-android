    ...
    Scaffold(
                ...
                actions = {
                    IconButton(onClick = onShare) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.cd_share_prompt),
                        )
                    }
                    IconButton(onClick = { onEdit(group.id) }) {
                        Icon(
                            imageVector = Icons.Default.Edit,
                            contentDescription = stringResource(R.string.cd_edit_prompt),
                        )
                    }
                    IconButton(onClick = onDelete) {
                        Icon(
                            imageVector = Icons.Default.Delete,
                            contentDescription = stringResource(R.string.cd_delete_prompt),
        ...
        Column(
            ...
            if (!group.command.isNullOrBlank()) {
                ...
                Text(
                    text = stringResource(R.string.prompt_command_label),
