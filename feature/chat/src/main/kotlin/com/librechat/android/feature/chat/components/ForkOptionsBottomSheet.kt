...
fun ForkOptionsBottomSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.fork_conversation),
            ...
            ForkOptionRow(
                ...
                label = stringResource(R.string.fork_visible_messages),
                description = stringResource(R.string.fork_visible_messages_desc),
                onClick = { onFork(ForkOption.DIRECT_PATH, splitAtTarget) },
            )

            ForkOptionRow(
                icon = Icons.AutoMirrored.Filled.CallSplit,
                label = stringResource(R.string.fork_include_branches),
                description = stringResource(R.string.fork_include_branches_desc),
                onClick = { onFork(ForkOption.INCLUDE_BRANCHES, splitAtTarget) },
            )

            ForkOptionRow(
                icon = Icons.Default.AccountTree,
                label = stringResource(R.string.fork_all_to_target),
                description = stringResource(R.string.fork_all_to_target_desc),
            ...
            Row(
                ...
                Column {
                    Text(
                        text = stringResource(R.string.fork_start_new),
                        style = MaterialTheme.typography.bodyMedium,
                    )
                    Text(
                        text = stringResource(R.string.fork_start_new_desc),
