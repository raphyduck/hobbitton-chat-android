...
fun PresetPicker(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            if (presets.isEmpty()) {
                Text(
                    text = stringResource(R.string.no_presets_saved),
    ...
    Row(
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.cd_edit_preset, preset.title),
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.cd_delete_preset, preset.title),
