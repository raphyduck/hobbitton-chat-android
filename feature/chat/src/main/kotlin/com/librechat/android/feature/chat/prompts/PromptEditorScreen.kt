    ...
    Scaffold(
                    ...
                    if (!uiState.isNewPrompt && uiState.prompts.isNotEmpty()) {
                        IconButton(onClick = viewModel::showVersionsSheet) {
                            Icon(
                                ...
                                contentDescription = stringResource(R.string.cd_version_history),
                            )
                        }
                    }
                },
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.prompt_command_label)) },
                singleLine = true,
            ...
            Text(
                text = stringResource(R.string.prompt_content),
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.prompt_text_label)) },
