...
fun PromptsLibraryScreen(
    ...
    Scaffold(
        ...
        topBar = {
            LibreChatTopBar(
                title = stringResource(R.string.prompts_library),
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = { onNavigateToEditor(null) }) {
                Icon(Icons.Default.Add, contentDescription = stringResource(R.string.cd_create_prompt))
            }
        },
    ) { innerPadding ->
        PullToRefreshBox(
                    ...
                    FlowRow(
                        ...
                        if (uiState.sortOrder != PromptSortOrder.RECENT) {
                            FilterChip(
                                ...
                                label = { Text(stringResource(R.string.prompt_sort_label, uiState.sortOrder.label)) },
                                trailingIcon = {
                                    Icon(
                                        Icons.Default.Close,
                                        contentDescription = stringResource(R.string.cd_reset_sort),
                                        modifier = Modifier.width(16.dp),
                                    )
                                },
                            )
    ...
    Card(
        ...
        Column(
            ...
            Row {
                ...
                Text(
                    text = stringResource(R.string.prompt_author, group.authorName),
                    style = MaterialTheme.typography.labelSmall,
