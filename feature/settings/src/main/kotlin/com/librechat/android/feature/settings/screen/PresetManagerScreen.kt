...
fun PresetManagerScreen(
    ...
    Scaffold(
        ...
        PullToRefreshBox(
            ...
            when {
                ...
                !uiState.isLoading && uiState.presets.isEmpty() -> {
                    EmptyState(
                        title = stringResource(R.string.no_presets),
                        description = stringResource(R.string.no_presets_desc),
    ...
    if (deleteConfirmation != null) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.dialog_title_delete_preset)) },
            text = {
                Text(
                    text = stringResource(R.string.dialog_delete_preset_message, deleteConfirmation?.title ?: ""),
