...
fun ApiKeysScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.title_api_keys)) },
                navigationIcon = {
            ...
            if (uiState.error == null || uiState.keys.isNotEmpty()) {
                FloatingActionButton(onClick = viewModel::showCreateDialog) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.cd_create_api_key),
                    )
                }
            }
        },
                ...
                !uiState.isLoading && uiState.error != null && uiState.keys.isEmpty() -> {
                    Box(
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(R.string.api_keys_not_available),
                                style = MaterialTheme.typography.titleMedium,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                            Text(
                                text = stringResource(R.string.api_keys_not_supported),
                ...
                !uiState.isLoading && uiState.keys.isEmpty() -> {
                    Box(
                        ...
                        Column(
                            ...
                            Text(
                                text = stringResource(R.string.no_api_keys),
                                style = MaterialTheme.typography.titleMedium,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                            Text(
                                text = stringResource(R.string.no_api_keys_desc),
                                style = MaterialTheme.typography.bodyMedium,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                        }
    ...
    keyToDelete?.let { key ->
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.dialog_title_delete_api_key)) },
            text = {
                Text(stringResource(R.string.dialog_delete_api_key_message, key.name))
            },
            confirmButton = {
                TextButton(
                    onClick = {
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (createdAt != null) {
                    ...
                    Text(
                        text = stringResource(R.string.created_prefix, formatDate(createdAt)),
            ...
            if (isDeleting) {
                ...
                IconButton(onClick = onDeleteClick) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.cd_delete_api_key),
