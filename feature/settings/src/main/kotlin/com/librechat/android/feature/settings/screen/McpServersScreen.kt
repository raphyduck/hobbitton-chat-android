...
fun McpServersScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.title_mcp_servers)) },
                navigationIcon = {
                    ...
                    if (uiState.tools.isNotEmpty()) {
                        IconButton(onClick = { viewModel.showToolsSheet() }) {
                            Icon(
                                ...
                                contentDescription = stringResource(R.string.cd_view_all_tools),
                            )
                        }
                    }
                },
        ...
        if (uiState.isLoading && uiState.servers.isEmpty()) {
            ...
            ErrorBanner(
                message = uiState.error ?: stringResource(R.string.error_failed_to_load_servers),
...
private fun McpServerListItem(
            ...
            Row(
                ...
                IconButton(
                    ...
                    if (isReinitializing) {
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.cd_reinitialize),
                            modifier = Modifier.size(20.dp),
                ...
                if (toolCount > 0) {
                    IconButton(onClick = onShowTools, modifier = Modifier.size(36.dp)) {
                        Icon(
                            imageVector = Icons.Default.Build,
                            contentDescription = stringResource(R.string.cd_view_tools),
                            modifier = Modifier.size(20.dp),
                            tint = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
                    }
    ...
    if (showDeleteConfirm) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.dialog_title_delete_server)) },
            text = { Text(stringResource(R.string.dialog_delete_server_message, server.name)) },
            confirmButton = {
                TextButton(
                    onClick = {
