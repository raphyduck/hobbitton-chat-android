...
internal fun PersonalizationDialog(
    ...
    AlertDialog(
        ...
        modifier = modifier,
        title = { Text(stringResource(R.string.personalization)) },
        text = {
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.enable_personalization),
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.response_style_label)) },
                    supportingText = {
