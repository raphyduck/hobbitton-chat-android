...
import com.librechat.android.core.model.mcp.McpAuthorizationType
...
internal fun McpServerDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(stringResource(if (isEditing) R.string.edit_mcp_server else R.string.add_mcp_server))
        },
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(
                            stringResource(R.string.mcp_description_label) + " " +
                                "(" + stringResource(R.string.mcp_description_optional) + ")",
                        )
                    },
                    minLines = 2,
                    maxLines = 4,
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.mcp_url_label)) },
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth(),
                )
                ...
                Text(
                    text = stringResource(R.string.mcp_type_label),
                ...
                SingleChoiceSegmentedButtonRow(modifier = Modifier.fillMaxWidth()) {
                    typeOptions.forEachIndexed { index, type ->
                        SegmentedButton(
                            ...
                            Text(
                                when (type) {
                                    McpServerType.SSE -> stringResource(R.string.mcp_type_sse)
                                    McpServerType.STREAMABLE_HTTP, McpServerType.HTTP -> stringResource(R.string.mcp_type_streamable_http)
                                    else -> type.name
                                },
                            )
                        }
                ...
                Spacer(modifier = Modifier.height(16.dp))
                Text(
                    text = stringResource(R.string.mcp_auth_label),
                    style = MaterialTheme.typography.titleSmall,
                )
                Spacer(modifier = Modifier.height(8.dp))
                ...
                SingleChoiceSegmentedButtonRow(modifier = Modifier.fillMaxWidth()) {
                    McpAuthMode.entries.forEachIndexed { index, mode ->
                        SegmentedButton(
                            ...
                            Text(
                                when (mode) {
                                    McpAuthMode.NONE -> stringResource(R.string.mcp_auth_none)
                                    McpAuthMode.API_KEY -> stringResource(R.string.mcp_auth_api_key)
                                    McpAuthMode.OAUTH -> stringResource(R.string.mcp_auth_oauth)
                                },
                            )
                        }
                    }
                ...
                AnimatedVisibility(visible = authMode == McpAuthMode.API_KEY) {
                    Column {
                        ...
                        AnimatedVisibility(visible = apiKeyAuthType == McpAuthorizationType.CUSTOM) {
                            Column {
                                ...
                                OutlinedTextField(
                                    ...
                                    label = { Text(stringResource(R.string.mcp_header_name_label)) },
                                    placeholder = { Text(stringResource(R.string.mcp_header_name_placeholder)) },
                                    singleLine = true,
                                    modifier = Modifier.fillMaxWidth(),
                                )
                            }
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.mcp_api_key_label)) },
                            singleLine = true,
                ...
                AnimatedVisibility(visible = authMode == McpAuthMode.OAUTH) {
                    Column {
                        ...
                        OutlinedTextField(
                            ...
                            placeholder = { Text(stringResource(R.string.mcp_oauth_scope_placeholder)) },
                            singleLine = true,
                            modifier = Modifier.fillMaxWidth(),
                        )
                    }
...
private fun ApiKeyAuthTypeSelector(
    ...
    ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
            value = when (selected) {
                McpAuthorizationType.BEARER -> stringResource(R.string.mcp_auth_bearer)
                McpAuthorizationType.BASIC -> stringResource(R.string.mcp_auth_basic)
                McpAuthorizationType.CUSTOM -> stringResource(R.string.mcp_auth_custom)
            },
            onValueChange = {},
            readOnly = true,
            label = { Text(stringResource(R.string.mcp_auth_key_type)) },
            trailingIcon = {
