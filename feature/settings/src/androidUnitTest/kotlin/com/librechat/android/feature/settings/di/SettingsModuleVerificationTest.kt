    ...
    fun verifySettingsModule() {
        settingsModule.verify(
            extraTypes = listOf(
                ...
                com.librechat.android.feature.settings.util.ContentReader::class,
                com.librechat.android.feature.settings.util.PlatformCacheCleaner::class,
                com.librechat.android.feature.settings.viewmodel.delegate.SpeechSettingsFactory::class,
            ),
        )
    }
}
